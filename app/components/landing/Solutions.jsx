    ...
    <section id="solutions" className="relative z-10 bg-white/60 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4 py-16 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <div
            className={cx(
              "mb-3 inline-flex items-center gap-2 rounded-full px-3 py-1 text-xs font-medium border",
              tone.border200,
              tone.text600,
              tone.bg50
            )}
          ...
          {variant.solutions.map((card, i) => (
            <div key={i} className="rounded-2xl border border-neutral-200 bg-white shadow-sm">
              ...
              <div className="p-6">
                ...
                <a className={cx("mt-5 inline-flex items-center rounded-xl px-4 py-2 text-sm font-medium text-white", tone.bg600, tone.hoverBg500)}>
                  {card.cta}
                </a>
              </div>
            </div>
