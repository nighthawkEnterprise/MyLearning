                    ...
                    <ul className="mt-4 space-y-2 text-sm text-neutral-700">
                      {card.points.map((p, j) => (
                        <li key={j} className="flex items-center gap-2">
                          <span className={cx("inline-block h-1.5 w-1.5 rounded-full", tone.bullet500)}></span> {p}
                        </li>
                      ))}
                    </ul>
        ...
        <section id="pricing" className="relative z-10 bg-white/60 backdrop-blur">
          <div className="mx-auto max-w-7xl px-4 py-16 md:px-6">
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              {/* Pro */}
              <div className={cx("rounded-2xl bg-white p-6 shadow-md border-2", tone.border600)}>
